...
public class CameraFragment extends Fragment implements SurfaceHolder.Callback, Camera.PictureCallback{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mView = (TouchView) view.findViewById(R.id.left_top_view);
        ...
        Log.e("mIsPortrait",mImageParameters.mIsPortrait+"");
        Log.e("IsPortrait",mImageParameters.isPortrait()+"");
...
//        final ImageView swapCameraBtn = (ImageView) com.rideflag.main.view.findViewById(R.id.change_camera);
...
//                        Double[] ratio = getRatio();
                        int left = (int) (double)mView.getmLeftTopPosX();
                        // 0 is height
                        int top = (int) (double)mView.getmLeftTopPosY();

                        int right = (int)(double)mView.getmRightBottomPosX();

                        int bottom = (int)(double)mView.getmRightBottomPosY();
...
//                        Double[] ratio = getRatio();
                ...
                Log.e("left top x", String.valueOf(left));
                Log.e("left tp y", String.valueOf(top));
                Log.e("right btm x", String.valueOf(right));
                Log.e("right btm y", String.valueOf(bottom));
            }
        });
        tGetPic.start();
...
//        Log.d(TAG, "Rotate Picture by: " + rotation);
        getFragmentManager()
                ...
                .replace(
                        ...
                        EditSavePhotoFragment.newInstance(data, rotation, mImageParameters.createCopy(),mOrientationListener.mCurrentNormalizedOrientation),
